...
export default function LoginSD() {
  return (
    <div style={styles.container}>
      ...
      <div style={{ marginRight: '900px', marginTop: '300px', fontSize: '50px', letterSpacing: '0.05', color:'black',fontWeight: 'bold' }}>Liên Hệ</div>
      <div style={{ marginRight: '660px',fontSize: '20px', letterSpacing: '0.05', color:'gray', fontFamily: 'Inter, sans-serif',lineHeight:'1.5' }}>
        Hãy liên hệ với chúng tôi nếu bạn cần trợ giúp. <br />
        Chúng tôi sẽ phản hồi bạn sớm nhất có thể <br />
      </div>
      <input type="text" placeholder="Họ và Tên" style={{ ...styles.button, padding: '20px 80px 20px 10px', marginBottom: '20px',marginTop: '40px',marginRight:'810px', borderRadius: '10px', backgroundColor: '#FFFFFF', color: '#000000', border: '2px solid #1488DB' }} />
      <input type="email" placeholder="Email" style={{ ...styles.button, padding: '20px 80px 20px 10px', marginBottom: '20px', borderRadius: '10px',marginRight:'810px', backgroundColor: '#FFFFFF', color: '#000000', border: '2px solid #1488DB' }} />
      <input type="text" placeholder="Tin nhắn" style={{ ...styles.button, padding: '20px 80px 20px 10px', marginBottom: '500px', borderRadius: '10px',marginRight:'810px', backgroundColor: '#FFFFFF', color: '#000000', border: '2px solid #1488DB' }} />
      <button style={{ ...styles.button, padding: '10px 40px', marginBottom: '-280px', borderRadius: '10px',marginRight:'810px', fontSize: '15px', position: 'absolute' }}>Gửi</button>
      <div style={styles.rightRectangle}>
      </div>

      <div style={styles.rectangle}>
        <div style={{ marginLeft: '80px',marginTop: '20px', display: 'inline-block', fontSize: '36px' }}>Thông tin liên hệ</div> <br /><br />
        <div style={{ marginLeft: '80px', marginTop: '20px', display: 'inline-block', fontSize: '16px',lineHeight:'1.5' }}>
          ssps@hcmut.edu.vn<br /><br />
          +84 0123 456 789 <br /> <br />
          CS1 Đại học Bách Khoa TP.HCM,<br />
          Lý Thường Kiệt, Quận 10, TP.HCM <br /><br />
          7h30 - 18h, Thứ 2 - Thứ 6
        </div>
      </div>
      <div style={{ ...styles.smallrectangle, position: 'absolute', top: '90px', left: '715px' }}></div>
